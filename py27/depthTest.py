...
color_space = 11
fps = 15
name = "pepper_stereo_camera"
cam_name = video_proxy.subscribeCamera(name, 3, resolution, color_space, fps)
if not cam_name:
    ...
    try:
        while True:
            ...
            if data:
                ...
                z_cen = float(coords[2])
                print("Co-ordinates: ", x_cen, y_cen, z_cen)
