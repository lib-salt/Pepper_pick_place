...
class PepperMotion:
    def __init__(self, motion_proxy, speech_proxy=None, tracker_proxy=None, awareness_proxy=None):
    ...
    def stop_if_close(self, distance, stop_threshold=0.2):
        # Stop movement if object is closer than threshold
        try:
            if distance <= stop_threshold:
                self.motion_proxy.stopMove()
                logger.info("Object is ", distance, "m away, stopping")
                return True
            return False
